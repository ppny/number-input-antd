...
const InputNumber = 
  (
    { config, value, onChange, onInput, onFocus, onBlur, addonAfter, className, ...rest }
  ) => {
    // 设置临界值
    const ref = React.createRef();
    const breakValue = (val) => {
      let newVal = val;
    ...
    const handleChange = (e) => {
      ...
      let index = getFocusIndex(el); // 获取焦点位置
      ...
      val = breakValue(minus + integer + decimal);
